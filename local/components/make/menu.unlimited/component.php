...
* @var CUser $USER
* @var CBitrixMenuUnlimitedComponent $this
*/

global $CACHE_MANAGER;

//Menu depth level
// Не было времени полностью кастомизировать компонент, пожтому такой костыль в виде увеличения родного лимита вложенности
if (isset($arParams["MAX_LEVEL"]) && 1 < intval($arParams["MAX_LEVEL"]) && intval($arParams["MAX_LEVEL"]) <= 100)
