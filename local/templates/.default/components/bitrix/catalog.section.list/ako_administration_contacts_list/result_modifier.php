...
/* Перебор и получение членов коллегии губернатора */
$inCollegiumSections = array();
foreach ($arResult['SECTIONS'] as $section) {
    if ($section["UF_SHOW_IN_CONTACTS"] == 1) {
        $section["MAN_PHOTO"] = CFile::GetPath($section["UF_MAN_PHOTO"]);
        $inCollegiumSections[] = $section;
    }
}

$arResult["SECTIONS"] = $inCollegiumSections;
