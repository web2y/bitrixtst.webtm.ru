        ...
        <? foreach ($arResult['SECTIONS'] as &$arSection): ?>
            ...
            <? if ($arSection["UF_DEP_TYPE"] == 1): ?>
                ...
                <a href="<? echo $arSection["SECTION_PAGE_URL"]; ?>"
                   ...
                   class="card-person-post collegium-content__person-introduction popup-block-link"
                   data-event-init="false">
            ...
            <? else: ?>
                <div class="preview__small preview__small--bold"
                     id="<? echo $this->GetEditAreaId($arSection['ID']); ?>">
                    <a class="preview-small__title popup-block-link" href="<? echo $arSection["SECTION_PAGE_URL"]; ?>"
                       data-event-init="false">
                        <? echo $arSection["NAME"] ?>
                    </a>
